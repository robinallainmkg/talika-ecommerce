...
// ─── Prompt enrichi ─────────────────────────────────────────────
// Le prompt copié = contexte business live (/api/context) + mission + accès data
// + livrable/garde-fous. Objectif : que Claude Code reçoive un dossier
// auto-suffisant, pas une question nue. (CLAUDE.md §6 — le companion détecte,
// Claude Code raisonne : ce bloc EST le pont entre les deux.)
...
function buildFullPrompt(prompt: string, contextPack: string | null): string {
